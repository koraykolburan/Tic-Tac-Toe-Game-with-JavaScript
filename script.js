...
const drawBoard = () => {
  boxes.forEach((box, i) => {
    let styleString = "";
    if (i < 3) {
      styleString += "border-bottom: 3px dotted var(--text);";
    }
    if (i % 3 === 0) {
      styleString += "border-right: 3px dotted var(--text);";
    }
    if (i % 3 === 2) {
      styleString += "border-left: 3px dotted var(--text);";
    }
    if (i > 5) {
      styleString += "border-top: 3px dotted var(--text);";
    }
